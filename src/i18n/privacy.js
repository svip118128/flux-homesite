// Privacy Policy translations - 胜启园基本功能隐私政策
export default {
    zh: {
    ...
    vi: {
        "privacy.title": "Chinh sach bao mat chuc nang co ban JDChat",
        "privacy.updateDate": "Ngay cap nhat",
        "privacy.effectiveDate": "Ngay hieu luc",

        // Introduction
        "privacy.intro.title": "Gioi thieu",
        "privacy.intro.p1": "Chao mung ban den voi san pham va dich vu cua chung toi! Chung toi hieu tam quan trong cua thong tin ca nhan doi voi ban, vi vay chung toi da xay dung Chinh sach bao mat chuc nang co ban JDChat nay. Vui long doc va hieu day du tat ca noi dung cua chinh sach nay truoc khi su dung san pham.",
        "privacy.intro.p2": "JDChat la ung dung cong cu tich hop chat tuc thoi va chuc nang cong tac. De cung cap cho ban dich vu truyen thong co ban nhu van ban, hinh anh, giong noi, video, cung nhu ghi chu va tai lieu cong tac truc tuyen, chung toi co the thu thap cac thong tin can thiet sau:",
        "privacy.intro.item1": "So dien thoai cung cap khi dang ky",
        "privacy.intro.item2": "Thong tin tai khoan (nhu danh sach lien lac, biet danh, anh dai dien, v.v.)",
        "privacy.intro.item3": "Thong tin thiet bi co ban (nhu model thiet bi, phien ban OS, ma dinh danh thiet bi, v.v.)",
        "privacy.intro.item4": "Thong tin nhat ky (nhu thoi gian dang nhap, ban ghi hoat dong, nhat ky loi, v.v.)",
        "privacy.intro.item5": "Thong tin ket noi mang (nhu dia chi IP, loai mang, v.v.)",
        "privacy.intro.p3": "Chinh sach nay chi ap dung cho viec thu thap va su dung thong tin ca nhan trong cac chuc nang co ban cua JDChat. Neu ban su dung cac chuc nang mo rong, chung toi se giai thich va xin su dong y cua ban sau khi co su uy quyen ro rang.",

        // Table of Contents
        "privacy.toc.title": "Muc luc chinh sach",
        "privacy.toc.s1": "Pham vi ap dung",
        "privacy.toc.s2": "Thu thap va su dung thong tin",
        "privacy.toc.s3": "Chia se, chuyen va cong khai thong tin",
        "privacy.toc.s4": "Quyen cua ban",
        "privacy.toc.s5": "Luu tru thong tin",
        "privacy.toc.s6": "Bao ve tre vi thanh nien",
        "privacy.toc.s7": "Lien he voi chung toi",

        // Section 1
        "privacy.s1.title": "1. Pham vi ap dung",
        "privacy.s1.p1": "Chinh sach nay ap dung cho cac chuc nang co ban chat tuc thoi va van phong truc tuyen do phan mem JDChat va cac ban cap nhat tiep theo cung cap.",
        "privacy.s1.p2": "Chinh sach nay khong ap dung cho san pham va dich vu do cac cong ty lien ket hoac nha cung cap dich vu ben thu ba cung cap. Vui long tham khao chinh sach bao mat rieng cua ho.",

        // Section 2
        "privacy.s2.title": "2. Thu thap va su dung thong tin",
        "privacy.s2.intro": "Chung toi chi thu thap thong tin can thiet sau khi ban uy quyen dong y de cung cap cac chuc nang co ban. Neu ban tu choi, ban se khong the su dung dich vu binh thuong.",
        "privacy.s2.sub1.title": "Dang ky va quan ly tai khoan",
        "privacy.s2.sub1.desc": "Ban can cung cap so dien thoai de dang ky tai khoan, va co the tu nguyen hoan thien thong tin nhu biet danh, anh dai dien, gioi tinh. Mot so thong tin (nhu biet danh, anh dai dien) se duoc hien thi cong khai.",
        "privacy.s2.sub2.title": "Dang nhap duoc uy quyen",
        "privacy.s2.sub2.desc": "Ban co the chon uy quyen su dung tai khoan JDChat de dang nhap ung dung ben thu ba, hoac dang nhap JDChat thong qua ben thu ba. Chung toi se xu ly thong tin lien quan theo pham vi uy quyen.",
        "privacy.s2.sub3.title": "Chuc nang nhan tin tuc thoi",
        "privacy.s2.sub3.desc": "Khi su dung chuc nang chat, chung toi se ghi lai du lieu tin nhan can thiet (van ban, hinh anh, giong noi, v.v.) va nhat ky hoat dong de thuc hien truyen va dong bo thong tin. Gui anh va tep can quyen luu tru, gui giong noi va chup anh can quyen micro va camera. Chia se vi tri can quyen vi tri cua ban.",
        "privacy.s2.sub4.title": "Bao ve an ninh",
        "privacy.s2.sub4.desc": "Chung toi cam ket cung cap moi truong truyen thong an toan cho ban. De ngan chan va kiem soat gian lan mang vien thong va duy tri hoat dong mang binh thuong, chung toi se thu thap ma dinh danh thiet bi, ma dinh danh bien doi, thong tin ung dung, tham so thiet bi va thong tin he thong, thong tin moi truong mang thiet bi, thong tin nha mang, v.v.",
        "privacy.s2.sub5.title": "Dich vu bo sung dua tren quyen he thong",
        "privacy.s2.sub5.desc": "Chung toi co the yeu cau quyen he thong trong cac dich vu bo sung de thu thap va su dung thong tin ca nhan cua ban. Neu ban khong dong y bat cac quyen lien quan, se khong anh huong den viec su dung dich vu co ban JDChat, nhung ban se khong the su dung cac dich vu bo sung nay. Ban co the bat hoac tat cac quyen nay bat cu luc nao.",
        "privacy.s2.sub6.title": "Dich vu Cookie va cong nghe tuong tu",
        "privacy.s2.sub6.desc": "Khi ban su dung dich vu cua chung toi, chung toi co the su dung cookie hoac ma dinh danh an danh de thu thap, xac dinh va luu tru thong tin ve cac lan truy cap va su dung san pham nay cua ban. Chung toi cam ket khong su dung cookie cho bat ky muc dich nao khac ngoai nhung gi duoc mo ta trong chinh sach bao mat nay.",
        "privacy.s2.sub7.title": "Cac quy tac khac ve thu thap va su dung thong tin ca nhan",
        "privacy.s2.sub7.desc": "Neu thong tin ban cung cap chua thong tin ca nhan cua nguoi khac, ban can dam bao rang ban da co su uy quyen hop phap truoc khi cung cap cho JDChat. Neu chung toi su dung thong tin cho cac muc dich khong duoc neu trong chinh sach nay, chung toi se xin su dong y cua ban truoc.",

        // Section 3
        "privacy.s3.title": "3. Chia se, chuyen va cong khai thong tin",
        "privacy.s3.sub1.title": "Chuyen thong tin",
        "privacy.s3.sub1.desc": "Neu chung toi can chuyen thong tin ca nhan do sap nhap, chia tach, giai the hoac pha san, chung toi se thong bao cho ban ten va thong tin lien he cua nguoi nhan. Nguoi nhan se tiep tuc thuc hien chinh sach nay va cac nghia vu phap ly khac.",
        "privacy.s3.sub2.title": "Cong khai",
        "privacy.s3.sub2.desc": "Chung toi chi cong khai thong tin ca nhan cua ban khi ban chu dong chon hoac bang cach khac co su dong y rieng cua ban. Neu chung toi xac dinh ban vi pham luat phap hoac cac thoa thuan va quy tac lien quan den JDChat, chung toi co the tiet lo thong tin ca nhan cua ban.",
        "privacy.s3.sub3.title": "Ngung hoat dong",
        "privacy.s3.sub3.desc": "Neu chung toi ngung cung cap san pham hoac dich vu, chung toi se ngay lap tuc ngung thu thap thong tin ca nhan cua ban va thong bao cho ban thong qua thong bao ca nhan hoac thong bao. Chung toi se xoa hoac an danh hoa thong tin ca nhan lien quan ma chung toi nam giu.",
        "privacy.s3.sub4.title": "Truong hop khong can uy quyen",
        "privacy.s3.sub4.desc": "Theo luat phap, khong can su dong y uy quyen cua ban cho: ky ket va thuc hien hop dong hoac quan ly nhan su; thuc hien nghia vu phap ly; bao ve tinh mang, suc khoe va an toan tai san cua ca nhan trong truong hop khan cap.",

        // Section 4
        "privacy.s4.title": "4. Quyen cua ban",
        "privacy.s4.p1": "Ban co the xoa mot so thong tin cua minh hoac dang ky huy tai khoan de xoa tat ca thong tin cua ban.",
        "privacy.s4.p2": "Trong cac truong hop sau, ban co the lien he dich vu khach hang de yeu cau xoa thong tin ca nhan:",
        "privacy.s4.item1": "Viec xu ly thong tin ca nhan cua chung toi vi pham luat phap",
        "privacy.s4.item2": "Chung toi thu thap va su dung thong tin ca nhan cua ban ma khong co su dong y ro rang cua ban",
        "privacy.s4.item3": "Viec xu ly thong tin ca nhan cua chung toi vi pham nghiem trong thoa thuan cua chung toi voi ban",
        "privacy.s4.item4": "Muc dich xu ly cua chung toi da dat duoc, khong the dat duoc hoac khong con can thiet",
        "privacy.s4.item5": "Chung toi da ngung cung cap san pham hoac dich vu, hoac thoi gian luu tru da het",
        "privacy.s4.p3": "Ban co the gui yeu cau quyen du lieu thong qua 'Cai dat & Bao mat - Trung tam an ninh - Quyen du lieu' trong ung dung JDChat hoac thong qua cac phuong thuc lien he cua chung toi. Nguoi dung ca nhan co the dang nhap va nhan 'Toi - Cai dat tai khoan - Huy tai khoan JDChat' de huy.",

        // Section 5
        "privacy.s5.title": "5. Luu tru thong tin",
        "privacy.s5.p1": "Chung toi chi luu giu thong tin ca nhan cua ban trong thoi gian can thiet de dat duoc cac muc dich duoc mo ta trong chinh sach nay, tru khi luat phap yeu cau luu tru bat buoc. Vi du, Luat Thuong mai dien tu yeu cau thong tin san pham va dich vu va thong tin giao dich phai duoc luu giu khong duoi ba nam ke tu ngay hoan thanh giao dich.",
        "privacy.s5.p2": "Sau khi het thoi gian luu tru, chung toi se xoa hoac an danh hoa thong tin ca nhan cua ban theo luat hien hanh. Neu ban lo lang ve thong tin ca nhan cua minh, dac biet la ro ri tai khoan hoac mat khau, vui long lien he ngay voi dich vu khach hang cua chung toi.",

        // Section 6
        "privacy.s6.title": "6. Bao ve tre vi thanh nien",
        "privacy.s6.p1": "Trong cac hoat dong van phong so, giao tiep va cong tac, chung toi gia dinh rang ban co nang luc dan su tuong ung. Neu ban la nguoi chua thanh nien, chung toi yeu cau cha me hoac nguoi giam ho khac cua ban doc ky chinh sach nay va su dung dich vu cua chung toi hoac cung cap thong tin cho chung toi voi su dong y cua ho.",
        "privacy.s6.p2": "Neu ban la cha me hoac nguoi giam ho khac cua tre em, vui long chu y xem tre co su dung dich vu cua chung toi sau khi co su uy quyen va dong y cua ban hay khong. Neu ban co cau hoi ve thong tin ca nhan cua tre, vui long lien he voi bo phan bao ve thong tin ca nhan cua chung toi.",

        // Section 7
        "privacy.s7.title": "7. Lien he voi chung toi",
        "privacy.s7.p1": "Ban co the lien he voi chung toi thong qua cac phuong thuc sau, va chung toi se tra loi yeu cau cua ban trong vong 10 ngay lam viec. Neu ban co bat ky cau hoi, y kien hoac de xuat nao ve chinh sach nay, ban co the lien he voi chung toi thong qua 'Toi - Lien he chung toi - Dich vu truc tuyen'.",
        "privacy.s7.company": "Cong ty",
        "privacy.s7.companyValue": "Cong ty TNHH Cong nghe Minggushan Vu Han",
        "privacy.s7.email": "Email",
        "privacy.s7.address": "Dia chi",
        "privacy.s7.addressValue": "B91, Tang 13, Toa nha 1, Don vi 1, Trung tam thuong mai Vanke Golden Domain, So 29 Duong Fangji, Pho Yangyuan, Quan Wuchang, Thanh pho Vu Han, Tinh Ho Bac, Trung Quoc",

        // SDK Appendix
        "privacy.sdk.title": "Phu luc: Thong tin thu thap SDK ben thu ba",
        "privacy.sdk.intro": "De thuc hien va dam bao viec thuc hien va hoat dong on dinh cua mot so chuc nang cua ung dung, chung toi co the truy cap cac bo cong cu phat trien phan mem (SDK) do ben thu ba cung cap. Cac SDK nay co the thu thap thong tin thiet bi cua ban hoac thong tin can thiet khac. Chung toi se giam sat chat che hanh vi thu thap thong tin cua doi tac de bao ve an ninh thong tin cua ban.",
        "privacy.sdk.note": "Chung toi chi goi cac dich vu SDK lien quan khi can thiet, thuc hien danh gia tuan thu truoc khi truy cap va ky thoa thuan bao ve du lieu voi ben thu ba. Hanh vi thu thap cua cac SDK ben thu ba nay chiu su rang buoc cua cac chinh sach bao mat tuong ung cua ho. Vui long doc ky cac tuyen bo bao mat cua ho de hieu day du hon."
    }
}
